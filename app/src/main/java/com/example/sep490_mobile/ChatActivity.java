...
public class ChatActivity extends AppCompatActivity implements GifAdapter.OnGifSelectedListener {
    ...
    private ImageButton sendBtn, imageBtn, gifBtn, videoBtn, btnCall, btnVideoCall, btnAudioCall;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAudioCall.setOnClickListener(v -> {
            ...
            intent.putExtra("IS_VIDEO_CALL", false); // audio call
            intent.putExtra("IS_OUTGOING", true);    // đánh dấu chiều gọi
        ...
        btnVideoCall.setOnClickListener(v -> {
            ...
            intent.putExtra("RECEIVER_ID", receiverId);
            intent.putExtra("RECEIVER_NAME", receiverName);
            intent.putExtra("IS_VIDEO_CALL", true);  // video call
            intent.putExtra("IS_OUTGOING", true);    // đánh dấu chiều gọi
            startActivity(intent);
        });
    }
